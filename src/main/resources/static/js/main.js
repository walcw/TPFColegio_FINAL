...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const sampleTracks = [
        { title: "Tema 1: Always_On_My_Mind", url: "/music/Always_On_My_Mind.mp3" },
        { title: "Tema 2: Bee_Gees_-_Tragedy", url: "/music/Bee_Gees_-_Tragedy.mp3" },
        { title: "Tema 3: How_Deep_Is_Your_Love", url: "/music/How_Deep_Is_Your_Love.mp3" },
        { title: "Tema 4: More_than_a_woman", url: "/music/More_than_a_woman.mp3" },
        { title: "Tema 5: My_Way", url: "/music/My_Way.mp3" },
